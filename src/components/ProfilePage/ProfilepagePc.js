...
function Profilepagepc() {
  ...
  const [user,updateUser] = React.useState({listOfHobbies:[]});
    ...
    const [showSave, updateShowSave] = React.useState(false);
    ...
    return (
        <div>
            ...
            <div style={{ height:"80%", width:"50%"}} >
                <Paper style={useStylesPC} sx={{p: '50px',margin:"10%", borderRadius: '24px'}}>
